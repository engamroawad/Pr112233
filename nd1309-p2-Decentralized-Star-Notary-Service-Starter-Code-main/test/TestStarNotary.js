...
it('lets 2 users exchange stars', async() => {
    ...
    await instance.createStar('awesome star', tokenId2, {from: user2});
   // console.log(instance.ownerOf(tokenId1));
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let instance = await StarNotary.deployed();
    let user1 = accounts[3];
    await instance.createStar('star star', tokenId, {from: user1});
    assert.equal(await instance.lookUptokenIdToStarInfo.call(tokenId),'star star');
});